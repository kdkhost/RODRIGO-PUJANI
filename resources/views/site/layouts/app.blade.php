...
<head>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box}html{font-size:16px}
        ...
        @media (max-width:768px),(hover:none),(pointer:coarse){body{cursor:auto!important}.cursor,.cursor-ring{display:none!important}.site-pwa-promo{left:1rem;right:1rem;bottom:1rem;max-width:none}}
    ...
    <script type="application/ld+json">{!! json_encode($schema, JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES|JSON_PRETTY_PRINT|JSON_HEX_TAG|JSON_HEX_AMP|JSON_HEX_APOS|JSON_HEX_QUOT) !!}</script>
</head>
<body>
    @if (session('status'))
