<section class="py-24 lg:py-36" style="background:#0F1017;">
    <div class="max-w-5xl mx-auto px-6 lg:px-16">
        <div class="card-glass p-8 lg:p-12">
            <div class="prose prose-lg prose-invert max-w-none text-cream/70">{!! safe_html($page->body) !!}</div>
            @foreach($page->sections as $section)
                ...
                @endif
                <div class="prose prose-invert max-w-none text-cream/70">{!! safe_html($section->content) !!}</div>
            @endforeach
        </div>
    </div>
</section>
