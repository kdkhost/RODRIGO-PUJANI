        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div>
                ...
                <h2 class="font-display leading-tight mb-8 aos delay-100" style="font-size:clamp(2rem,4vw,3.2rem);font-weight:300;">
                    {!! safe_html($section?->title ?: 'Estratégia jurídica que<br><span class="text-gold-gradient font-semibold">transforma resultados</span>') !!}
                </h2>
                <div class="text-cream/50 leading-relaxed mb-8 aos delay-200">
                    {!! safe_html($section?->content ?: e($page->excerpt ?: 'Não apenas representamos. Construímos estratégias personalizadas que consideram cada detalhe do caso, o contexto do cliente e os objetivos de negócio.')) !!}
                </div>
