        ...
        <div class="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
                ...
                <blockquote class="font-display leading-tight mb-10 aos delay-100" style="font-size:clamp(2rem,4vw,3.2rem);font-weight:300;font-style:italic;border-left:2px solid var(--gold);padding-left:1.5rem;">
                    "O direito não é apenas uma profissão — é um compromisso com a justiça e com as pessoas."
                </blockquote>
                <p class="text-cream/50 leading-relaxed mb-10 aos delay-200">
                    {!! $page->body ?: 'Fundado com a missão de democratizar o acesso à advocacia de alto nível, o escritório Pujani Advogados reúne profissionais especializados com formação sólida e atuação estratégica.' !!}
                </p>
