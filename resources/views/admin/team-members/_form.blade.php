            ...
            @if($record->image_path)
                <div class="admin-brand-preview-card mt-3">
                    ...
                    <div class="admin-brand-preview-image mt-2" style="min-height: 180px;">
                        <img src="{{ site_asset_url($record->image_path) }}" alt="{{ $record->name }}" style="max-height: 160px; border-radius: 0.8rem;">
                    </div>
                    <div class="mt-2 small text-muted">Foto atual: <a href="{{ site_asset_url($record->image_path) }}" target="_blank" rel="noopener">{{ $record->image_path }}</a></div>
                </div>
            @endif
        </div>
