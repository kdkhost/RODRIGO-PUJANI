                    ...
                    <div class="card admin-table-card">
                        ...
                        <div class="card-body p-4">
                            <div class="row g-3 admin-premium-form">
                                    ...
                                    <div class="admin-premium-surface p-3">
                                        <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
                                            <div>
                                                ...
                                                <small class="text-muted">Clique para inserir no campo ativo do assunto, cabecalho, corpo ou rodape.</small>
                                            </div>
                                ...
                                <div class="col-12">
                                    <label class="form-label" for="mail_template_custom_css">CSS adicional do template</label>
                                    <textarea id="mail_template_custom_css" name="mail_template_custom_css" class="form-control mail-template-input font-monospace" rows="5" placeholder=".system-mail-subject { letter-spacing: 0; }">{{ old('mail_template_custom_css', $mailTheme['custom_css']) }}</textarea>
                                </div>
                                <div class="col-12">
                                    <div class="admin-premium-surface p-3">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const renderPreview = () => {
        ...
        const brand = document.getElementById('brand_name')?.value || '{{ addslashes(config('app.name')) }}';
        ...
        preview.innerHTML = `
            <style>
                ...
                #mail-template-preview .preview-shell .preview-body h1, #mail-template-preview .preview-shell .preview-body h2, #mail-template-preview .preview-shell .preview-body h3, #mail-template-preview .preview-shell .preview-body strong { color:${headingColor}; }
