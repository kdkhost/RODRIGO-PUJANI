@php
    $groups = [
        ...
        'Jurídico' => [
            ...
            ['label' => 'Intimações / DJEN', 'route' => 'admin.djen-publications.index', 'active' => 'admin.djen-*', 'icon' => 'bi-bank2', 'permission' => 'djen-publications.view'],
            ['label' => 'Prazos', 'route' => 'admin.legal-tasks.index', 'active' => 'admin.legal-tasks.*', 'icon' => 'bi-alarm', 'permission' => 'legal-tasks.manage'],
            ['label' => 'Agenda', 'route' => 'admin.calendar.index', 'active' => 'admin.calendar.*', 'icon' => 'bi-calendar3', 'permission' => 'calendar.manage'],
            ['label' => 'Google Calendar', 'route' => 'admin.google-calendar.index', 'active' => 'admin.google-calendar.*', 'icon' => 'bi-google', 'permission' => 'google-calendar.manage'],
            ...
            ['label' => 'Gerador de documentos', 'route' => 'admin.legal-document-templates.index', 'active' => 'admin.legal-document-templates.*', 'icon' => 'bi-file-earmark-richtext', 'permission' => 'legal-document-templates.view'],
            ['label' => 'Transcrição de Audiências', 'route' => 'admin.hearing-transcriptions.index', 'active' => 'admin.hearing-transcriptions.*', 'icon' => 'bi-mic', 'permission' => 'hearing-transcriptions.manage'],
            ['label' => 'Financeiro', 'route' => 'admin.financial-entries.index', 'active' => 'admin.financial-entries.*', 'icon' => 'bi-wallet2', 'permission' => 'financial.manage'],
        ...
        'Operação' => [
            ...
            ['label' => 'IA jurídica', 'route' => 'admin.legal-ai.index', 'active' => 'admin.legal-ai.*', 'icon' => 'bi-stars', 'permission' => 'legal-ai.configure'],
