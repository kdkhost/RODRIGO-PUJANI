...
<div class="app-content-header admin-page-hero">
    <div class="container-fluid">
        <div class="admin-page-hero-inner">
            <div>
                <div class="admin-eyebrow">Monitoramento oficial do CNJ</div>
                <h1>Intimações e publicações do DJEN</h1>
                <p>Revisão humana obrigatória antes da publicação de qualquer conteúdo no portal do cliente.</p>
            </div>
...
<div class="app-content">
    <div class="container-fluid">
        <div class="row g-4 mb-4">
            @foreach([
                ...
                <div class="col-6 col-xl-3">
                    <div class="card admin-table-card h-100"><div class="card-body d-flex align-items-center gap-3">
        ...
        <div class="card admin-table-card mb-4">
            <div class="card-header"><h3 class="card-title"><i class="bi bi-funnel me-2"></i>Filtros</h3></div>
            <div class="card-body admin-card-flow">
                <form method="GET" action="{{ route('admin.djen-publications.index') }}" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-2 d-flex gap-2"><button class="btn btn-primary flex-fill" type="submit">Filtrar</button><a class="btn btn-outline-secondary" href="{{ route('admin.djen-publications.index') }}" aria-label="Limpar filtros" title="Limpar filtros"><i class="bi bi-x-lg"></i></a></div>
                </form>
            </div>
        </div>

        <div class="card admin-table-card mb-4">
            <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2"><h3 class="card-title">Central de revisão</h3><span class="text-muted small">Nada é liberado automaticamente ao cliente.</span></div>
        ...
        <div class="row g-4">
            <div class="col-xl-7">
                <div class="card admin-table-card h-100">
                    <div class="card-header"><h3 class="card-title"><i class="bi bi-radar me-2"></i>Monitores configurados</h3></div>
                    <div class="card-body table-responsive p-0">
            ...
            <div class="col-xl-5">
                <div class="card admin-table-card h-100">
                    <div class="card-header"><h3 class="card-title"><i class="bi bi-plus-circle me-2"></i>Novo monitor</h3></div>
                    <div class="card-body admin-card-flow">
