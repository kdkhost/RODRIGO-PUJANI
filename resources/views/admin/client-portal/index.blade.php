...
@section('content')
    <div class="app-content-header admin-page-hero">
        <div class="container-fluid">
            <div class="admin-page-hero-inner">
                <div>
                    <div class="admin-eyebrow">Experiência do cliente</div>
                    <h1>{{ $pageTitle }}</h1>
                    <p>Personalize a entrada do portal do cliente e defina o comportamento da integração opcional com o DataJud.</p>
                </div>
    ...
    <div class="app-content">
        <div class="container-fluid">
            <form action="{{ route('admin.client-portal.update') }}" method="POST" data-ajax-form class="row g-4">
                @csrf
                @method('PUT')
                ...
                <div class="col-xl-5">
                    <div class="card admin-table-card mb-4">
                        <div class="card-header">
                            <div>
                                <div class="admin-card-kicker">Integração CNJ</div>
                                <h3 class="card-title">DataJud</h3>
                            </div>
                        </div>
                        <div class="card-body p-4">
                            <div class="admin-premium-form">
                                <label class="form-label">Chave pública do DataJud</label>
                                <input type="text" name="datajud_api_key" class="form-control" value="{{ old('datajud_api_key', $config['portal.datajud_api_key']) }}" placeholder="Opcional: deixe em branco para usar a chave pública atual do CNJ">
                                <div class="form-text mt-2">
                                    Se este campo ficar vazio, o sistema tenta buscar automaticamente a chave pública vigente na wiki oficial do DataJud.
                                </div>
                            </div>
                        </div>
                    </div>
