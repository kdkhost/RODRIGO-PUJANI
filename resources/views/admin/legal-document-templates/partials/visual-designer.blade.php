...
<div class="legal-doc-designer"
    data-document-designer
    data-brand-logo="{{ $brandLogo }}"
    data-background-upload-url="{{ route('admin.legal-document-templates.background-upload') }}"
    data-default-background-save-url="{{ route('admin.legal-document-templates.default-background') }}"
    data-default-background-path="{{ $defaultBackgroundPath }}"
    data-default-background-opacity="{{ $defaultBackgroundOpacity }}"
    data-default-background-fit="{{ $defaultBackgroundFit }}"
    ...
    <div class="legal-doc-designer-header">
        <div>
            ...
            <p>Use papel timbrado, grade, margens, editor Summernote e posições em milímetros para manter o PDF idêntico à criação e à impressão.</p>
        </div>
        ...
        <section class="legal-doc-tool-card legal-doc-tool-card-background">
            <div class="legal-doc-tool-card-header">
                ...
                <div>
                    ...
                    <small>Envie, visualize e reutilize o fundo padrão nos próximos documentos.</small>
                </div>
            </div>
            <div class="legal-doc-bg-workspace">
                <div class="legal-doc-bg-drop" data-doc-bg-drop role="button" tabindex="0">
                    <input type="file" accept="image/png,image/jpeg,image/webp" hidden data-doc-bg-file>
                    <i class="bi bi-cloud-arrow-up"></i>
                    <span>Arraste o papel timbrado aqui</span>
                    <small>ou clique para selecionar PNG, JPG ou WEBP até 10 MB</small>
                </div>
                <div class="legal-doc-bg-preview" data-doc-bg-preview>
                    <div class="legal-doc-bg-preview-frame">
                        <img data-doc-bg-preview-image src="" alt="Prévia do papel timbrado">
                        <i class="bi bi-file-earmark-image"></i>
                    </div>
                    <div>
                        <strong data-doc-bg-preview-title>Sem fundo nesta página</strong>
                        <small data-doc-bg-preview-meta>Envie uma imagem ou aplique o padrão do sistema.</small>
                    </div>
                </div>
            </div>
            <label class="form-label mb-1" for="doc-background-path">Caminho do fundo</label>
            <div class="input-group input-group-sm">
                <input class="form-control" id="doc-background-path" data-doc-bg-path placeholder="Ex.: uploads/legal-document-backgrounds/papel-timbrado.png">
                <button class="btn btn-outline-secondary" type="button" data-doc-clear-bg title="Remove o fundo apenas da página selecionada">
                    Limpar
                </button>
            </div>
            <div class="legal-doc-bg-actions">
                <button class="btn btn-sm btn-outline-primary" type="button" data-doc-apply-default-bg>
                    <i class="bi bi-magic me-1"></i>Aplicar padrão
                </button>
                <button class="btn btn-sm btn-primary" type="button" data-doc-save-default-bg>
                    <i class="bi bi-save me-1"></i>Salvar como padrão
                </button>
            </div>
            <small class="legal-doc-bg-status" data-doc-bg-status>O padrão do sistema fica salvo no banco e reaproveitado em novos documentos.</small>
        </section>
    ...
    <div class="legal-doc-designer-grid">
        ...
        <aside class="legal-doc-inspector">
            ...
            <div class="row g-2">
                ...
                <div class="col-12" data-doc-type-field="text">
                    <label class="form-label">Texto do documento</label>
                    <textarea class="form-control form-control-sm legal-doc-rich-text" rows="6" data-doc-field="text_html" data-editor="summernote" data-editor-height="240"></textarea>
                    <small class="text-muted">Use formatação rica com Summernote; a posição e o tamanho continuam controlados em milímetros.</small>
                </div>
