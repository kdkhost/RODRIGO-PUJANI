    ...
    <div class="row g-4 admin-premium-form">
        <div class="col-12">
            <div class="admin-premium-surface p-3 p-lg-4">
                <div class="row g-3">
                    <div class="col-12">
                        <div class="admin-card-kicker">Identificacao</div>
                    </div>
                                        ...
                                        <div class="admin-upload-preview-item">
                                            ...
                                            <div class="admin-upload-preview-info">
                                                <div class="admin-upload-preview-title">
                                                    <strong>{{ $record->name ?: 'Usuario' }}</strong>
                                                    <span>Avatar</span>
                                                </div>
        ...
        <div class="col-12">
            <div class="admin-premium-surface p-3 p-lg-4">
                <div class="row g-3">
                    <div class="col-12">
                        <div class="admin-card-kicker">Endereco completo</div>
                    </div>
                    ...
                    <div class="col-md-2"><label class="form-label">Numero</label><input type="text" name="address_number" class="form-control" value="{{ old('address_number', $record->address_number) }}" placeholder="100"></div>
                    <div class="col-md-4"><label class="form-label">Complemento</label><input type="text" name="address_complement" class="form-control" value="{{ old('address_complement', $record->address_complement) }}" placeholder="Sala, bloco ou referencia"></div>
        ...
        <div class="col-12">
            <div class="admin-premium-surface p-3 p-lg-4">
                <div class="row g-3">
                    <div class="col-12">
                        <div class="admin-card-kicker">Acesso e permissoes</div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        @if($roleLocked)
                            ...
                            <div class="form-text">Conta protegida. A funcao Super Admin nao pode ser removida.</div>
                        @endif
                    </div>
                    <div class="col-12 form-check">
                        ...
                        <label class="form-check-label" for="user_active">Usuario ativo</label>
                    </div>
                    <div class="col-md-6 form-check">
                        <input type="checkbox" class="form-check-input" id="user_pref_internal" name="pref_receive_internal_messages" value="1" @checked(old('pref_receive_internal_messages', $record->pref_receive_internal_messages ?? true))>
                        <label class="form-check-label" for="user_pref_internal">Receber mensagens internas</label>
                    </div>
                    <div class="col-md-6 form-check">
                        <input type="checkbox" class="form-check-input" id="user_pref_whatsapp" name="pref_receive_whatsapp_messages" value="1" @checked(old('pref_receive_whatsapp_messages', $record->pref_receive_whatsapp_messages ?? true))>
                        <label class="form-check-label" for="user_pref_whatsapp">Receber mensagens via WhatsApp</label>
                    </div>
                </div>
            </div>
        </div>
